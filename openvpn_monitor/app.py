...
from vpns.openvpn.disconnector import VPNDisconnector
from location_data.maxmind.geoip import GeoipDBLoader
...
def openvpn_monitor_wsgi():
    ...
    csrf.init_app(app)
    app.secret_key = b'_53oi3uriq9pifpff;aplasd'
